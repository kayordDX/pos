...
export type AdjustmentGetAllQueryError = ErrorType<null | InternalErrorResponse>;
...
export type AdjustmentCreateMutationError = ErrorType<null | InternalErrorResponse>;
