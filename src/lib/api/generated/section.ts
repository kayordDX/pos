...
export type SectionUpdateMutationError = ErrorType<ErrorResponse | null | InternalErrorResponse>;
...
export type SectionGetQueryError = ErrorType<ErrorResponse | null | InternalErrorResponse>;
...
export type SectionTableGetAllQueryResult = NonNullable<
	Awaited<ReturnType<typeof sectionTableGetAll>>
>;
export type SectionTableGetAllQueryError = ErrorType<ErrorResponse | null | InternalErrorResponse>;
...
export type SectionListQueryError = ErrorType<ErrorResponse | null | InternalErrorResponse>;
...
export type SectionCreateMutationError = ErrorType<ErrorResponse | null | InternalErrorResponse>;
...
export const sectionDelete = (id: number) => {
	return customInstance<null>({ url: `/section/${id}`, method: "DELETE" });
};
...
export type SectionDeleteMutationError = ErrorType<ErrorResponse | null | InternalErrorResponse>;
