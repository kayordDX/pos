...
export const getSectionUpdateMutationOptions = <
	TData = Awaited<ReturnType<typeof sectionUpdate>>,
...
export const getSectionCreateMutationOptions = <
	TData = Awaited<ReturnType<typeof sectionCreate>>,
	TError = ErrorType<ErrorResponse | InternalErrorResponse>,
	TContext = unknown,
>(options?: {
	mutation?: CreateMutationOptions<
...
>(options?: {
	mutation?: CreateMutationOptions<
		...
		TContext
	>;
}): CreateMutationResult<TData, TError, { data: BodyType<SectionCreateRequest> }, TContext> => {
