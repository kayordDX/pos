...
export const getCashUpUserDeleteMutationOptions = <
	TData = Awaited<ReturnType<typeof cashUpUserDelete>>,
	TError = ErrorType<void | InternalErrorResponse>,
	TContext = unknown,
>(options?: {
...
export const getCashUpUserCreateMutationOptions = <
	TData = Awaited<ReturnType<typeof cashUpUserCreate>>,
	TError = ErrorType<void | InternalErrorResponse>,
	TContext = unknown,
>(options?: {
...
>(options?: {
	mutation?: CreateMutationOptions<
		...
		TContext
	>;
}): CreateMutationResult<TData, TError, { data: BodyType<CashUpUserCreateRequest> }, TContext> => {
...
export const getCashUpUserCloseMutationOptions = <
	TData = Awaited<ReturnType<typeof cashUpUserClose>>,
	TError = ErrorType<void | InternalErrorResponse>,
	TContext = unknown,
>(options?: {
	mutation?: CreateMutationOptions<
...
>(options?: {
	mutation?: CreateMutationOptions<
		...
		TContext
	>;
}): CreateMutationResult<TData, TError, { data: BodyType<CashUpUserCloseRequest> }, TContext> => {
