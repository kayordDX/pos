...
export type OptionUpdateMutationError = ErrorType<null | InternalErrorResponse>;
...
export type OptionGroupQueryError = ErrorType<null | InternalErrorResponse>;
...
export type OptionCreateMutationError = ErrorType<null | InternalErrorResponse>;
...
export type OptionItemsQueryError = ErrorType<null | InternalErrorResponse>;
...
export const optionDelete = (id: number) => {
	return customInstance<null>({ url: `/option/${id}`, method: "DELETE" });
};
...
export type OptionDeleteMutationError = ErrorType<ErrorResponse | null | InternalErrorResponse>;
...
export type OptionGroupUpdateMutationError = ErrorType<null | InternalErrorResponse>;
...
export type OptionGroupCreateMutationError = ErrorType<null | InternalErrorResponse>;
...
export const optionGroupDelete = (id: number) => {
	return customInstance<null>({ url: `/option/group/${id}`, method: "DELETE" });
};
