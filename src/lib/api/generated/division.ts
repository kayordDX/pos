...
export type DivisionCreateMutationError = ErrorType<void | void | InternalErrorResponse>;
...
export const divisionDelete = (id: number) => {
	return customInstance<void>({ url: `/division/${id}`, method: "DELETE" });
};
...
>(
	...
	TContext
> => {
	const mutationOptions = getDivisionDeleteMutationOptions(options);
