...
export type ExtraGroupUpdateMutationError = ErrorType<null | InternalErrorResponse>;
...
export type ExtraGroupCreateMutationError = ErrorType<null | InternalErrorResponse>;
...
export const extraGroupDelete = (id: number) => {
	return customInstance<null>({ url: `/extraGroup/${id}`, method: "DELETE" });
};
...
export type ExtraGroupDeleteMutationError = ErrorType<null | InternalErrorResponse>;
