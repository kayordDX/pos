...
export type SupplierUpdateMutationError = ErrorType<null | InternalErrorResponse>;
...
export type SupplierGetAllQueryError = ErrorType<null | InternalErrorResponse>;
...
export type SupplierCreateMutationError = ErrorType<null | InternalErrorResponse>;
...
export const supplierDelete = (id: number) => {
	return customInstance<null>({ url: `/supplier/${id}`, method: "DELETE" });
};
...
export type SupplierDeleteMutationError = ErrorType<ErrorResponse | null | InternalErrorResponse>;
