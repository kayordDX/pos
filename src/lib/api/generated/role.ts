...
export const roleDelete = (id: number) => {
	return customInstance<EntitiesRole>({ url: `/role/${id}`, method: "DELETE" });
};
...
>(
	...
	TContext
> => {
	const mutationOptions = getRoleDeleteMutationOptions(options);
...
export type RoleCreateMutationError = ErrorType<void | void | InternalErrorResponse>;
