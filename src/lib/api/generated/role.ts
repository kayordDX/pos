...
export const getRoleCreateMutationOptions = <
	TData = Awaited<ReturnType<typeof roleCreate>>,
	TError = ErrorType<InternalErrorResponse>,
	TContext = unknown,
>(options?: {
	mutation?: CreateMutationOptions<TData, TError, { data: BodyType<RoleCreateRequest> }, TContext>;
}) => {
...
>(options?: {
	mutation?: CreateMutationOptions<TData, TError, { data: BodyType<RoleCreateRequest> }, TContext>;
}): CreateMutationResult<TData, TError, { data: BodyType<RoleCreateRequest> }, TContext> => {
