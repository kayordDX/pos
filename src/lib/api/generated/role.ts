...
export type UserCreateRoleMutationError = ErrorType<null | InternalErrorResponse>;
...
export type RoleUpdateMutationError = ErrorType<null | InternalErrorResponse>;
...
export type RoleTypeGetAllQueryError = ErrorType<null | InternalErrorResponse>;
...
export type RoleGetAllQueryError = ErrorType<null | InternalErrorResponse>;
...
export type RoleDivisionGetAllQueryResult = NonNullable<
	Awaited<ReturnType<typeof roleDivisionGetAll>>
>;
export type RoleDivisionGetAllQueryError = ErrorType<null | InternalErrorResponse>;
...
export const roleDivisionDelete = (roleId: number, divisionId: number) => {
	return customInstance<null>({ url: `/role/division/${roleId}/${divisionId}`, method: "DELETE" });
};
...
export type RoleDivisionDeleteMutationError = ErrorType<null | InternalErrorResponse>;
...
export type RoleDivisionCreateMutationError = ErrorType<null | InternalErrorResponse>;
...
export type RoleCreateMutationError = ErrorType<null | null | InternalErrorResponse>;
