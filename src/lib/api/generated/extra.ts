...
export type ExtraUpdateMutationError = ErrorType<null | InternalErrorResponse>;
...
export type ExtraGroupQueryError = ErrorType<null | InternalErrorResponse>;
...
export type ExtraCreateMutationError = ErrorType<null | InternalErrorResponse>;
...
export type ExtraItemsQueryError = ErrorType<null | InternalErrorResponse>;
...
export const extraDelete = (id: number) => {
	return customInstance<null>({ url: `/extra/${id}`, method: "DELETE" });
};
...
export type ExtraDeleteMutationError = ErrorType<
...
export type ExtraGetAllMenuQueryError = ErrorType<null | InternalErrorResponse>;
...
export type ExtraGetAllQueryError = ErrorType<null | InternalErrorResponse>;
