...
export const getExtraUpdateMutationOptions = <
	TData = Awaited<ReturnType<typeof extraUpdate>>,
	TError = ErrorType<void | InternalErrorResponse>,
	TContext = unknown,
>(options?: {
	mutation?: CreateMutationOptions<TData, TError, { data: BodyType<ExtraUpdateRequest> }, TContext>;
}) => {
...
>(options?: {
	mutation?: CreateMutationOptions<TData, TError, { data: BodyType<ExtraUpdateRequest> }, TContext>;
}): CreateMutationResult<TData, TError, { data: BodyType<ExtraUpdateRequest> }, TContext> => {
...
export const getExtraCreateMutationOptions = <
	TData = Awaited<ReturnType<typeof extraCreate>>,
	TError = ErrorType<void | InternalErrorResponse>,
	TContext = unknown,
>(options?: {
	mutation?: CreateMutationOptions<TData, TError, { data: BodyType<ExtraCreateRequest> }, TContext>;
}) => {
...
>(options?: {
	mutation?: CreateMutationOptions<TData, TError, { data: BodyType<ExtraCreateRequest> }, TContext>;
}): CreateMutationResult<TData, TError, { data: BodyType<ExtraCreateRequest> }, TContext> => {
...
export const getExtraDeleteMutationOptions = <
	TData = Awaited<ReturnType<typeof extraDelete>>,
