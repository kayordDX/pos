...
export const getSalesPeriodCreateMutationOptions = <
	TData = Awaited<ReturnType<typeof salesPeriodCreate>>,
...
>(options?: {
	mutation?: CreateMutationOptions<
		...
		TContext
	>;
}): CreateMutationResult<TData, TError, { data: BodyType<SalesPeriodCreateRequest> }, TContext> => {
...
export const getSalesPeriodCloseMutationOptions = <
	TData = Awaited<ReturnType<typeof salesPeriodClose>>,
	TError = ErrorType<InternalErrorResponse>,
	TContext = unknown,
>(options?: {
	mutation?: CreateMutationOptions<
...
>(options?: {
	mutation?: CreateMutationOptions<
		...
		TContext
	>;
}): CreateMutationResult<TData, TError, { data: BodyType<SalesPeriodCloseRequest> }, TContext> => {
