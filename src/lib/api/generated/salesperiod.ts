...
export type SalesPeriodGetQueryError = ErrorType<null | InternalErrorResponse>;
...
export type SalesPeriodCloseMutationError = ErrorType<null | InternalErrorResponse>;
