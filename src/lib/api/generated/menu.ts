...
export const getMenuUpdateMutationOptions = <
	TData = Awaited<ReturnType<typeof menuUpdate>>,
	TError = ErrorType<ErrorResponse | void | InternalErrorResponse>,
	TContext = unknown,
>(options?: {
	mutation?: CreateMutationOptions<TData, TError, { data: BodyType<MenuUpdateRequest> }, TContext>;
}) => {
...
>(options?: {
	mutation?: CreateMutationOptions<TData, TError, { data: BodyType<MenuUpdateRequest> }, TContext>;
}): CreateMutationResult<TData, TError, { data: BodyType<MenuUpdateRequest> }, TContext> => {
...
export const getMenuCreateMutationOptions = <
	TData = Awaited<ReturnType<typeof menuCreate>>,
	TError = ErrorType<void | InternalErrorResponse>,
	TContext = unknown,
>(options?: {
	mutation?: CreateMutationOptions<TData, TError, { data: BodyType<MenuCreateRequest> }, TContext>;
}) => {
...
>(options?: {
	mutation?: CreateMutationOptions<TData, TError, { data: BodyType<MenuCreateRequest> }, TContext>;
}): CreateMutationResult<TData, TError, { data: BodyType<MenuCreateRequest> }, TContext> => {
...
export const getMenuDeleteMutationOptions = <
	TData = Awaited<ReturnType<typeof menuDelete>>,
	TError = ErrorType<ErrorResponse | void | InternalErrorResponse>,
	TContext = unknown,
>(options?: {
