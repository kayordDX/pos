...
export const getBillWhatsappBillMutationOptions = <
	TData = Awaited<ReturnType<typeof billWhatsappBill>>,
...
>(options?: {
	mutation?: CreateMutationOptions<
		...
		TContext
	>;
}): CreateMutationResult<TData, TError, { data: BodyType<BillWhatsappBillRequest> }, TContext> => {
...
export const getBillPrintBillMutationOptions = <
	TData = Awaited<ReturnType<typeof billPrintBill>>,
...
>(options?: {
	mutation?: CreateMutationOptions<
		...
		TContext
	>;
}): CreateMutationResult<TData, TError, { data: BodyType<BillPrintBillRequest> }, TContext> => {
...
export const getBillEmailBillMutationOptions = <
	TData = Awaited<ReturnType<typeof billEmailBill>>,
	TError = ErrorType<void | InternalErrorResponse>,
	TContext = unknown,
>(options?: {
	mutation?: CreateMutationOptions<
...
>(options?: {
	mutation?: CreateMutationOptions<
		...
		TContext
	>;
}): CreateMutationResult<TData, TError, { data: BodyType<BillEmailBillRequest> }, TContext> => {
