...
export type BillWhatsappBillMutationError = ErrorType<null | InternalErrorResponse>;
...
export type BillPrintBillMutationError = ErrorType<null | InternalErrorResponse>;
...
export type BillEmailBillMutationError = ErrorType<null | InternalErrorResponse>;
...
export const billDownloadBill = (tableBookingId: number) => {
	return customInstance<null>({ url: `/bill/download/${tableBookingId}`, method: "GET" });
};
...
export type BillDownloadBillQueryError = ErrorType<null | InternalErrorResponse>;
