...
export type AIGenerateStreamQueryError = ErrorType<ErrorResponse | null | InternalErrorResponse>;
...
export type AIGenerateMutationError = ErrorType<ErrorResponse | null | InternalErrorResponse>;
