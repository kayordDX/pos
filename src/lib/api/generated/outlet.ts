...
export const getOutletUpdateMutationOptions = <
	TData = Awaited<ReturnType<typeof outletUpdate>>,
...
export const getOutletCreateMutationOptions = <
	TData = Awaited<ReturnType<typeof outletCreate>>,
	TError = ErrorType<ErrorResponse | void | InternalErrorResponse>,
	TContext = unknown,
>(options?: {
	mutation?: CreateMutationOptions<
...
>(options?: {
	mutation?: CreateMutationOptions<
		...
		TContext
	>;
}): CreateMutationResult<TData, TError, { data: BodyType<OutletCreateRequest> }, TContext> => {
