...
export const getTableBookingPaymentEditMutationOptions = <
	TData = Awaited<ReturnType<typeof tableBookingPaymentEdit>>,
	TError = ErrorType<void | InternalErrorResponse>,
	TContext = unknown,
>(options?: {
...
export const getTableBookingCreateMutationOptions = <
	TData = Awaited<ReturnType<typeof tableBookingCreate>>,
	TError = ErrorType<ErrorResponse | InternalErrorResponse>,
	TContext = unknown,
>(options?: {
	mutation?: CreateMutationOptions<
...
export const getTableBookingCloseMutationOptions = <
	TData = Awaited<ReturnType<typeof tableBookingClose>>,
...
>(options?: {
	mutation?: CreateMutationOptions<
		...
		TContext
	>;
}): CreateMutationResult<TData, TError, { data: BodyType<TableBookingCloseRequest> }, TContext> => {
