...
export const tableBookingPeriodHistory = async (
	...
	params: TableBookingPeriodHistoryParams,
	options?: RequestInit
): Promise<TableBookingHistoryResponse[]> => {
...
export const tableBookingHistoryAll = async (
	...
	return customInstance<TableBookingHistoryResponse[]>(getTableBookingHistoryAllUrl(params), {
		...options,
		method: "GET",
	});
};
...
export const tableBookingHistory = async (
	...
	return customInstance<TableBookingHistoryResponse[]>(getTableBookingHistoryUrl(params), {
		...options,
		method: "GET",
	});
};
