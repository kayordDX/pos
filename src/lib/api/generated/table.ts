...
export type TableUpdateMutationError = ErrorType<ErrorResponse | null | InternalErrorResponse>;
...
export type TableGetMyBookedQueryError = ErrorType<ErrorResponse | null | InternalErrorResponse>;
...
export type TableGetAvailableQueryResult = NonNullable<
	Awaited<ReturnType<typeof tableGetAvailable>>
>;
export type TableGetAvailableQueryError = ErrorType<ErrorResponse | null | InternalErrorResponse>;
...
export const tableDelete = (id: number) => {
	return customInstance<null>({ url: `/table/${id}`, method: "DELETE" });
};
...
export type TableDeleteMutationError = ErrorType<ErrorResponse | null | InternalErrorResponse>;
...
export type TableCreateMutationError = ErrorType<ErrorResponse | null | InternalErrorResponse>;
