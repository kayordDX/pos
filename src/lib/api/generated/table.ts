...
export const getTableUpdateMutationOptions = <
	TData = Awaited<ReturnType<typeof tableUpdate>>,
...
export const getTableCreateMutationOptions = <
	TData = Awaited<ReturnType<typeof tableCreate>>,
	TError = ErrorType<ErrorResponse | InternalErrorResponse>,
	TContext = unknown,
>(options?: {
	mutation?: CreateMutationOptions<TData, TError, { data: BodyType<TableCreateRequest> }, TContext>;
}) => {
...
>(options?: {
	mutation?: CreateMutationOptions<TData, TError, { data: BodyType<TableCreateRequest> }, TContext>;
}): CreateMutationResult<TData, TError, { data: BodyType<TableCreateRequest> }, TContext> => {
