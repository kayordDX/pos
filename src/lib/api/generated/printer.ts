...
export type PrinterTestMutationError = ErrorType<ErrorResponse | null | InternalErrorResponse>;
...
export type PrinterScanResultsQueryResult = NonNullable<
	Awaited<ReturnType<typeof printerScanResults>>
>;
export type PrinterScanResultsQueryError = ErrorType<ErrorResponse | null | InternalErrorResponse>;
...
export type PrinterScanMutationError = ErrorType<ErrorResponse | null | InternalErrorResponse>;
...
export type PrinterListQueryError = ErrorType<null | InternalErrorResponse>;
...
export type PrinterEditMutationError = ErrorType<ErrorResponse | null | InternalErrorResponse>;
...
export type PrinterCreateMutationError = ErrorType<ErrorResponse | null | InternalErrorResponse>;
...
export const printerDelete = (id: number) => {
	return customInstance<null>({ url: `/printer/${id}`, method: "DELETE" });
};
...
export type PrinterDeleteMutationError = ErrorType<null | InternalErrorResponse>;
