...
export const getPrinterTestMutationOptions = <
	TData = Awaited<ReturnType<typeof printerTest>>,
	TError = ErrorType<ErrorResponse | void | InternalErrorResponse>,
	TContext = unknown,
>(options?: {
	mutation?: CreateMutationOptions<TData, TError, { data: BodyType<PrinterTestRequest> }, TContext>;
}) => {
...
>(options?: {
	mutation?: CreateMutationOptions<TData, TError, { data: BodyType<PrinterTestRequest> }, TContext>;
}): CreateMutationResult<TData, TError, { data: BodyType<PrinterTestRequest> }, TContext> => {
...
export const getPrinterEditMutationOptions = <
	TData = Awaited<ReturnType<typeof printerEdit>>,
	TError = ErrorType<ErrorResponse | void | InternalErrorResponse>,
	TContext = unknown,
>(options?: {
	mutation?: CreateMutationOptions<TData, TError, { data: BodyType<PrinterEditRequest> }, TContext>;
}) => {
...
>(options?: {
	mutation?: CreateMutationOptions<TData, TError, { data: BodyType<PrinterEditRequest> }, TContext>;
}): CreateMutationResult<TData, TError, { data: BodyType<PrinterEditRequest> }, TContext> => {
...
export const getPrinterCreateMutationOptions = <
	TData = Awaited<ReturnType<typeof printerCreate>>,
	TError = ErrorType<ErrorResponse | void | InternalErrorResponse>,
	TContext = unknown,
>(options?: {
...
>(options?: {
	mutation?: CreateMutationOptions<
		...
		TContext
	>;
}): CreateMutationResult<TData, TError, { data: BodyType<PrinterCreateRequest> }, TContext> => {
...
export const getPrinterDeleteMutationOptions = <
	TData = Awaited<ReturnType<typeof printerDelete>>,
	TError = ErrorType<void | InternalErrorResponse>,
	TContext = unknown,
>(options?: {
