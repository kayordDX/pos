...
export const getMenuItemUpdateMutationOptions = <
	TData = Awaited<ReturnType<typeof menuItemUpdate>>,
...
>(options?: {
	mutation?: CreateMutationOptions<
		...
		TContext
	>;
}): CreateMutationResult<TData, TError, { data: BodyType<MenuItemUpdateRequest> }, TContext> => {
...
export const getMenuItemCreateMutationOptions = <
	TData = Awaited<ReturnType<typeof menuItemCreate>>,
	TError = ErrorType<void | InternalErrorResponse>,
	TContext = unknown,
>(options?: {
	mutation?: CreateMutationOptions<
...
>(options?: {
	mutation?: CreateMutationOptions<
		...
		TContext
	>;
}): CreateMutationResult<TData, TError, { data: BodyType<MenuItemCreateRequest> }, TContext> => {
...
export const getMenuItemDeleteMutationOptions = <
	TData = Awaited<ReturnType<typeof menuItemDelete>>,
