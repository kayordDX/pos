...
export const getUserValidateMutationOptions = <
	TData = Awaited<ReturnType<typeof userValidate>>,
...
>(options?: {
	mutation?: CreateMutationOptions<
		...
		TContext
	>;
}): CreateMutationResult<TData, TError, { data: BodyType<UserValidateRequest> }, TContext> => {
...
export const getUserRemoveUserOutletRoleMutationOptions = <
	TData = Awaited<ReturnType<typeof userRemoveUserOutletRole>>,
	TError = ErrorType<ErrorResponse | void | InternalErrorResponse>,
	TContext = unknown,
>(options?: {
	mutation?: CreateMutationOptions<TData, TError, { userId: string; role: string }, TContext>;
}) => {
...
>(options?: {
	mutation?: CreateMutationOptions<TData, TError, { userId: string; role: string }, TContext>;
}): CreateMutationResult<TData, TError, { userId: string; role: string }, TContext> => {
...
export const getUserRemoveUserOutletMutationOptions = <
	TData = Awaited<ReturnType<typeof userRemoveUserOutlet>>,
	TError = ErrorType<ErrorResponse | void | InternalErrorResponse>,
	TContext = unknown,
>(options?: {
	mutation?: CreateMutationOptions<TData, TError, { userId: string }, TContext>;
}) => {
...
>(options?: {
	mutation?: CreateMutationOptions<TData, TError, { userId: string }, TContext>;
}): CreateMutationResult<TData, TError, { userId: string }, TContext> => {
...
export const getUserAssignOutletMutationOptions = <
	TData = Awaited<ReturnType<typeof userAssignOutlet>>,
	TError = ErrorType<void | InternalErrorResponse>,
	TContext = unknown,
>(options?: {
	mutation?: CreateMutationOptions<
...
>(options?: {
	mutation?: CreateMutationOptions<
		...
		TContext
	>;
}): CreateMutationResult<TData, TError, { data: BodyType<UserAssignOutletRequest> }, TContext> => {
...
export const getUserAddUserOutletRoleMutationOptions = <
	TData = Awaited<ReturnType<typeof userAddUserOutletRole>>,
	TError = ErrorType<void | InternalErrorResponse>,
	TContext = unknown,
>(options?: {
	mutation?: CreateMutationOptions<
