...
export const createUpdateTimeTicker = <TError = ErrorType<unknown>, TContext = unknown>(
	...
	TContext
> => {
	return createMutation(() => ({ ...getUpdateTimeTickerMutationOptions(options), queryClient }));
};
...
export const createDeleteTimeTicker = <TError = ErrorType<unknown>, TContext = unknown>(
	...
	TContext
> => {
	return createMutation(() => ({ ...getDeleteTimeTickerMutationOptions(options), queryClient }));
};
...
export const createUpdateCronTicker = <TError = ErrorType<unknown>, TContext = unknown>(
	...
	TContext
> => {
	return createMutation(() => ({ ...getUpdateCronTickerMutationOptions(options), queryClient }));
};
...
export const createDeleteCronTicker = <TError = ErrorType<unknown>, TContext = unknown>(
	...
	TContext
> => {
	return createMutation(() => ({ ...getDeleteCronTickerMutationOptions(options), queryClient }));
};
...
export const createRestartTickerHost = <TError = ErrorType<unknown>, TContext = unknown>(
	...
	return createMutation(() => ({ ...getRestartTickerHostMutationOptions(options), queryClient }));
};
