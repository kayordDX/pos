...
export const getTableOrderUpdateTableOrderMutationOptions = <
	TData = Awaited<ReturnType<typeof tableOrderUpdateTableOrder>>,
...
export const getTableOrderUpdateOrderItemMutationOptions = <
	TData = Awaited<ReturnType<typeof tableOrderUpdateOrderItem>>,
...
export const getTableOrderUpdateGroupOrderMutationOptions = <
	TData = Awaited<ReturnType<typeof tableOrderUpdateGroupOrder>>,
	TError = ErrorType<InternalErrorResponse>,
	TContext = unknown,
>(options?: {
	mutation?: CreateMutationOptions<
...
export const getTableOrderSendToKitchenMutationOptions = <
	TData = Awaited<ReturnType<typeof tableOrderSendToKitchen>>,
	TError = ErrorType<void | InternalErrorResponse>,
	TContext = unknown,
>(options?: {
	mutation?: CreateMutationOptions<
...
export const getTableOrderRemoveItemMutationOptions = <
	TData = Awaited<ReturnType<typeof tableOrderRemoveItem>>,
	TError = ErrorType<void | InternalErrorResponse>,
	TContext = unknown,
>(options?: {
	mutation?: CreateMutationOptions<
...
export const getTableOrderCopyItemMutationOptions = <
	TData = Awaited<ReturnType<typeof tableOrderCopyItem>>,
	TError = ErrorType<void | InternalErrorResponse>,
	TContext = unknown,
>(options?: {
	mutation?: CreateMutationOptions<
...
export const getOrderClearBasketMutationOptions = <
	TData = Awaited<ReturnType<typeof orderClearBasket>>,
	TError = ErrorType<void | InternalErrorResponse>,
	TContext = unknown,
>(options?: {
	mutation?: CreateMutationOptions<
...
>(options?: {
	mutation?: CreateMutationOptions<
		...
		TContext
	>;
}): CreateMutationResult<TData, TError, { data: BodyType<OrderClearBasketRequest> }, TContext> => {
...
export const getOrderAddItemsMutationOptions = <
	TData = Awaited<ReturnType<typeof orderAddItems>>,
	TError = ErrorType<void | InternalErrorResponse>,
	TContext = unknown,
>(options?: {
	mutation?: CreateMutationOptions<
...
>(options?: {
	mutation?: CreateMutationOptions<
		...
		TContext
	>;
}): CreateMutationResult<TData, TError, { data: BodyType<OrderAddItemsRequest> }, TContext> => {
