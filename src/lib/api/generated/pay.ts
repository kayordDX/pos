...
export const getPayPayConfigTestConfigMutationOptions = <
	TData = Awaited<ReturnType<typeof payPayConfigTestConfig>>,
	TError = ErrorType<void | InternalErrorResponse>,
	TContext = unknown,
>(options?: {
...
export const getPayPayConfigSetActiveMutationOptions = <
	TData = Awaited<ReturnType<typeof payPayConfigSetActive>>,
...
export const getPayPayConfigDeleteMutationOptions = <
	TData = Awaited<ReturnType<typeof payPayConfigDelete>>,
	TError = ErrorType<void | InternalErrorResponse>,
	TContext = unknown,
>(options?: {
...
export const getPayPayConfigCreateMutationOptions = <
	TData = Awaited<ReturnType<typeof payPayConfigCreate>>,
	TError = ErrorType<ErrorResponse | void | InternalErrorResponse>,
	TContext = unknown,
>(options?: {
	mutation?: CreateMutationOptions<
...
export const getPayManualPaymentMutationOptions = <
	TData = Awaited<ReturnType<typeof payManualPayment>>,
...
>(options?: {
	mutation?: CreateMutationOptions<
		...
		TContext
	>;
}): CreateMutationResult<TData, TError, { data: BodyType<PayManualPaymentRequest> }, TContext> => {
...
export const getPayCheckMutationOptions = <
	TData = Awaited<ReturnType<typeof payCheck>>,
	TError = ErrorType<void | InternalErrorResponse>,
	TContext = unknown,
>(options?: {
	mutation?: CreateMutationOptions<TData, TError, { data: BodyType<PayCheckRequest> }, TContext>;
}) => {
...
>(options?: {
	mutation?: CreateMutationOptions<TData, TError, { data: BodyType<PayCheckRequest> }, TContext>;
}): CreateMutationResult<TData, TError, { data: BodyType<PayCheckRequest> }, TContext> => {
