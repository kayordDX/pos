...
export type PayStatusQueryError = ErrorType<null | InternalErrorResponse>;
...
export type PayPayConfigTestConfigMutationError = ErrorType<null | InternalErrorResponse>;
...
export type PayPayConfigGetQueryError = ErrorType<null | InternalErrorResponse>;
...
export const payPayConfigDelete = (id: number) => {
	return customInstance<null>({ url: `/pay/config/${id}`, method: "DELETE" });
};
...
export type PayPayConfigDeleteMutationError = ErrorType<null | InternalErrorResponse>;
...
export type PayManualPaymentMutationError = ErrorType<null | InternalErrorResponse>;
...
export type PayGetLinkQueryError = ErrorType<null | InternalErrorResponse>;
...
export type PayCheckMutationError = ErrorType<null | InternalErrorResponse>;
