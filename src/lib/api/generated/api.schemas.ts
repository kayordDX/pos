...
export type EntitiesUser = EntitiesAuditableEntity &
	...
	Required<
		Pick<
			EntitiesAuditableEntity & EntitiesUserAllOf,
			"userId" | "email" | "image" | "name" | "isActive"
		>
	>;
...
export type EntitiesMenuItem = EntitiesAuditableEntity &
	EntitiesMenuItemAllOf &
	Required<
		Pick<
			EntitiesAuditableEntity & EntitiesMenuItemAllOf,
			| "menuItemId"
			| "menuSection"
			| "menuSectionId"
			| "name"
...
export type EntitiesMenuSection = EntitiesAuditableEntity &
	EntitiesMenuSectionAllOf &
	Required<
		Pick<
			EntitiesAuditableEntity & EntitiesMenuSectionAllOf,
			"menuSectionId" | "name" | "menu" | "menuId"
		>
	>;
...
export type EntitiesMenu = EntitiesAuditableEntity &
	...
	Required<
		Pick<
			EntitiesAuditableEntity & EntitiesMenuAllOf,
			"id" | "name" | "outletId" | "position" | "outlet"
		>
	>;
...
export type EntitiesStockOrder = EntitiesAuditableEntity &
	EntitiesStockOrderAllOf &
	Required<
		Pick<
			EntitiesAuditableEntity & EntitiesStockOrderAllOf,
			| "id"
			| "outletId"
			| "orderNumber"
			| "stockOrderStatusId"
...
export type EntitiesStock = EntitiesAuditableEntity &
	...
	Required<
		Pick<
			EntitiesAuditableEntity & EntitiesStockAllOf,
...
export type SalesPeriodCashUpCashUp = EntitiesCashUp &
	SalesPeriodCashUpCashUpAllOf &
	Required<Pick<EntitiesCashUp & SalesPeriodCashUpCashUpAllOf, "userCashUps">>;
...
export type EntitiesHaloConfig = EntitiesAuditableEntity &
	EntitiesHaloConfigAllOf &
	Required<
		Pick<
			EntitiesAuditableEntity & EntitiesHaloConfigAllOf,
			"id" | "outletId" | "xApiKey" | "merchantId" | "isEnabled" | "iv"
		>
	>;
