...
export const stockGetAll = async (
	...
	return customInstance<CommonModelsPaginatedListOfResponse3>(getStockGetAllUrl(params), {
		...options,
		method: "GET",
	});
};
...
export const stockGetAllDivision = async (
	...
	return customInstance<CommonModelsPaginatedListOfResponse2>(getStockGetAllDivisionUrl(params), {
		...options,
		method: "GET",
	});
};
