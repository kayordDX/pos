...
namespace Pos.Api.Data.Migrations
{
    ...
    public partial class Cashuptypes : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(name: "IX_CashupUserItem_CashupItemTypesId", table: "CashupUserItem", column: "CashupItemTypesId");

            migrationBuilder.CreateIndex(name: "IX_CashupUserItem_UserCashupId", table: "CashupUserItem", column: "UserCashupId");

            migrationBuilder.CreateIndex(name: "IX_CashupUserItemType_CashupConfigId", table: "CashupUserItemType", column: "CashupConfigId");

            migrationBuilder.CreateIndex(name: "IX_CashupUserItemType_PaymentTypeId", table: "CashupUserItemType", column: "PaymentTypeId");
        }

        /// <inheritdoc />
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DropTable(name: "CashupUserItem");

            migrationBuilder.DropTable(name: "CashupUserItemType");

            migrationBuilder.DropTable(name: "CashupUser");

            migrationBuilder.DropTable(name: "CashupConfig");
        }
    }
}
