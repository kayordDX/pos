...
namespace Pos.Api.Data.Migrations
{
    ...
    public partial class AllocationVacation : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(name: "IX_StockAllocate_AssignedUserUserId", table: "StockAllocate", column: "AssignedUserUserId");

            migrationBuilder.CreateIndex(name: "IX_StockAllocate_FromDivisionId", table: "StockAllocate", column: "FromDivisionId");

            migrationBuilder.CreateIndex(name: "IX_StockAllocate_FromUserUserId", table: "StockAllocate", column: "FromUserUserId");

            migrationBuilder.CreateIndex(name: "IX_StockAllocate_StockAllocateStatusId", table: "StockAllocate", column: "StockAllocateStatusId");

            migrationBuilder.CreateIndex(name: "IX_StockAllocate_ToDivisionId", table: "StockAllocate", column: "ToDivisionId");

            migrationBuilder.CreateIndex(name: "IX_StockAllocateItem_DivisionId", table: "StockAllocateItem", column: "DivisionId");

            migrationBuilder.CreateIndex(name: "IX_StockAllocateItem_StockAllocateId", table: "StockAllocateItem", column: "StockAllocateId");
            ...
            migrationBuilder.CreateIndex(name: "IX_StockAllocateItem_StockId", table: "StockAllocateItem", column: "StockId");

            migrationBuilder.CreateIndex(name: "IX_StockItemAudit_StockItemAuditTypeId", table: "StockItemAudit", column: "StockItemAuditTypeId");
        }

        /// <inheritdoc />
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DropTable(name: "StockAllocateItem");

            migrationBuilder.DropTable(name: "StockItemAudit");

            migrationBuilder.DropTable(name: "StockAllocateItemStatus");

            migrationBuilder.DropTable(name: "StockAllocate");

            migrationBuilder.DropTable(name: "StockItemAuditType");

            migrationBuilder.DropTable(name: "StockAllocateStatus");
        }
    }
}
