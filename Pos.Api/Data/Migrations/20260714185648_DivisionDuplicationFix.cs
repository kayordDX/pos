...
namespace Pos.Api.Data.Migrations
{
    ...
    public partial class DivisionDuplicationFix : Migration
    {
        ...
        {
            migrationBuilder.DropIndex(name: "ix_role_division_role_id_division_id", table: "role_division");

            migrationBuilder.DropIndex(name: "ix_division_division_name_outlet_id", table: "division");
        }
    }
}
