...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pos.Api.Entities.Inventory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Pos.Api.Entities.InventoryOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Pos.Api.Entities.InventoryStock", b =>
                {
                    b.Property<int>("InventoryId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Pos.Api.Entities.Location", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Pos.Api.Entities.Inventory", b =>
                {
                    b.HasOne("Pos.Api.Entities.Location", "Location")
                        .WithMany()
            ...
            modelBuilder.Entity("Pos.Api.Entities.InventoryOrder", b =>
                {
                    b.HasOne("Pos.Api.Entities.Inventory", "Inventory")
                        .WithMany()
            ...
            modelBuilder.Entity("Pos.Api.Entities.Location", b =>
                {
                    b.HasOne("Pos.Api.Entities.Address", "Address")
                        .WithMany()
