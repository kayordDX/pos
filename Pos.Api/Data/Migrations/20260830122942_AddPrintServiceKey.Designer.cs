...
namespace Pos.Api.Data.Migrations
{
    ...
    [Migration("20260830122942_AddPrintServiceKey")]
    partial class AddPrintServiceKey
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pos.Api.Entities.PrintServiceKey", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_print_service_key");

                    b.HasIndex("KeyId")
                        .IsUnique()
                        .HasDatabaseName("ix_print_service_key_key_id");

                    b.ToTable("print_service_key", (string)null);
                });
