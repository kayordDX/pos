        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(name: "FK_Customer_Table_TableId", column: x => x.TableId, principalTable: "Table", principalColumn: "TableId");
                }
            );
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(name: "FK_Tag_MenuItem_MenuItemId", column: x => x.MenuItemId, principalTable: "MenuItem", principalColumn: "MenuItemId");
                }
            );
            ...
            migrationBuilder.CreateIndex(name: "IX_Clock_OutletId", table: "Clock", column: "OutletId");

            migrationBuilder.CreateIndex(name: "IX_Clock_UserId", table: "Clock", column: "UserId");

            migrationBuilder.CreateIndex(name: "IX_Customer_TableId", table: "Customer", column: "TableId");

            migrationBuilder.CreateIndex(name: "IX_Extra_MenuItemId", table: "Extra", column: "MenuItemId");

            migrationBuilder.CreateIndex(name: "IX_Extra_OrderItemId", table: "Extra", column: "OrderItemId");

            migrationBuilder.CreateIndex(name: "IX_Menu_OutletId", table: "Menu", column: "OutletId");

            migrationBuilder.CreateIndex(name: "IX_MenuItem_MenuSectionId", table: "MenuItem", column: "MenuSectionId");

            migrationBuilder.CreateIndex(name: "IX_MenuItem_SearchVector", table: "MenuItem", column: "SearchVector").Annotation("Npgsql:IndexMethod", "GIN");

            migrationBuilder.CreateIndex(name: "IX_MenuItemOptionGroup_MenuItemId", table: "MenuItemOptionGroup", column: "MenuItemId");

            migrationBuilder.CreateIndex(name: "IX_MenuSection_MenuId", table: "MenuSection", column: "MenuId");

            migrationBuilder.CreateIndex(name: "IX_MenuSection_ParentId", table: "MenuSection", column: "ParentId");

            migrationBuilder.CreateIndex(name: "IX_Option_OptionGroupId", table: "Option", column: "OptionGroupId");

            migrationBuilder.CreateIndex(name: "IX_Option_OrderItemId", table: "Option", column: "OrderItemId");

            migrationBuilder.CreateIndex(name: "IX_OrderItem_MenuItemId", table: "OrderItem", column: "MenuItemId");

            migrationBuilder.CreateIndex(name: "IX_Outlet_BusinessId", table: "Outlet", column: "BusinessId");

            migrationBuilder.CreateIndex(name: "IX_SalesPeriod_OutletId", table: "SalesPeriod", column: "OutletId");

            migrationBuilder.CreateIndex(name: "IX_Section_OutletId", table: "Section", column: "OutletId");

            migrationBuilder.CreateIndex(name: "IX_Table_SectionId", table: "Table", column: "SectionId");

            migrationBuilder.CreateIndex(name: "IX_TableBooking_SalesPeriodId", table: "TableBooking", column: "SalesPeriodId");

            migrationBuilder.CreateIndex(name: "IX_TableBooking_TableId", table: "TableBooking", column: "TableId");

            migrationBuilder.CreateIndex(name: "IX_TableBooking_UserId", table: "TableBooking", column: "UserId");

            migrationBuilder.CreateIndex(name: "IX_TableCashUp_OutletId", table: "TableCashUp", column: "OutletId");

            migrationBuilder.CreateIndex(name: "IX_TableCashUp_TableBookingId", table: "TableCashUp", column: "TableBookingId");

            migrationBuilder.CreateIndex(name: "IX_TableOrder_CustomerId", table: "TableOrder", column: "CustomerId");

            migrationBuilder.CreateIndex(name: "IX_TableOrder_OrderItemId", table: "TableOrder", column: "OrderItemId");

            migrationBuilder.CreateIndex(name: "IX_Tag_MenuItemId", table: "Tag", column: "MenuItemId");

            migrationBuilder.CreateIndex(name: "IX_UserRole_RoleId", table: "UserRole", column: "RoleId");

            migrationBuilder.CreateIndex(name: "IX_UserRole_UserId", table: "UserRole", column: "UserId");
        }

        /// <inheritdoc />
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DropTable(name: "Clock");

            migrationBuilder.DropTable(name: "Extra");

            migrationBuilder.DropTable(name: "MenuItemOptionGroup");

            migrationBuilder.DropTable(name: "Option");

            migrationBuilder.DropTable(name: "OrderItemExtra");

            migrationBuilder.DropTable(name: "OrderItemOption");

            migrationBuilder.DropTable(name: "TableCashUp");

            migrationBuilder.DropTable(name: "TableOrder");

            migrationBuilder.DropTable(name: "Tag");

            migrationBuilder.DropTable(name: "UserOutlet");

            migrationBuilder.DropTable(name: "UserRole");

            migrationBuilder.DropTable(name: "OptionGroup");

            migrationBuilder.DropTable(name: "TableBooking");
            ...
            migrationBuilder.DropTable(name: "SalesPeriod");
            ...
            migrationBuilder.DropTable(name: "MenuSection");
