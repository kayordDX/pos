...
namespace Pos.Api.Data.Migrations
{
    ...
    public partial class OrderItemStatusNotify : Migration
    {
        ...
        {
            migrationBuilder.AddColumn<bool>(name: "Notify", table: "OrderItemStatus", type: "boolean", nullable: false, defaultValue: false);
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropColumn(name: "Notify", table: "OrderItemStatus");
        }
    }
}
