...
namespace Pos.Api.Data.Migrations
{
    ...
    public partial class VATRate : Migration
    {
        ...
        {
            migrationBuilder.AddColumn<int>(name: "stock_allocate_item_id", table: "stock_item_audit", type: "integer", nullable: true);

            migrationBuilder.AddColumn<int>(name: "stock_order_item_id", table: "stock_item_audit", type: "integer", nullable: true);
        ...
        {
            migrationBuilder.DropTable(name: "vat_rate");

            migrationBuilder.DropColumn(name: "stock_allocate_item_id", table: "stock_item_audit");

            migrationBuilder.DropColumn(name: "stock_order_item_id", table: "stock_item_audit");
