...
export interface TableGetBookedRequest {
	[key: string]: unknown;
}
...
export interface PrinterPrintResultsRequest {
	[key: string]: unknown;
}
...
export interface PrinterDeviceInfoResultsRequest {
	[key: string]: unknown;
}
...
export type PrinterPrintResultsParams = {
	outletId: number;
	deviceId: number;
	jobId: string;
};
