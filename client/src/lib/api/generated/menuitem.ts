...
): CreateMutationResult<Awaited<ReturnType<typeof menuItemUpdate>>, TError, MenuItemUpdateMutationVariables, TContext> => {
...
export const getMenuItemGetAllQueryOptions = <TData = Awaited<ReturnType<typeof menuItemGetAll>>, TError = ErrorType<void | InternalErrorResponse>>(
	params?: MenuItemGetAllParams,
	options?: { query?: Partial<CreateQueryOptions<Awaited<ReturnType<typeof menuItemGetAll>>, TError, TData>>; request?: SecondParameter<typeof customInstance> }
) => {
...
export const createMenuItemCreate = <TError = ErrorType<void | InternalErrorResponse>, TContext = unknown>(
	...
	queryClient?: () => QueryClient
): CreateMutationResult<Awaited<ReturnType<typeof menuItemCreate>>, TError, MenuItemCreateMutationVariables, TContext> => {
...
export const createMenuItemDelete = <TError = ErrorType<ErrorResponse | void | InternalErrorResponse>, TContext = unknown>(
	...
	queryClient?: () => QueryClient
): CreateMutationResult<Awaited<ReturnType<typeof menuItemDelete>>, TError, MenuItemDeleteMutationVariables, TContext> => {
